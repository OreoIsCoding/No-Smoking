...
import { User2Icon, LucideHome, MapPin } from "lucide-react";
import { GiPayMoney } from "react-icons/gi";

const Navbar = () => {
  return (
    <nav className="fixed bottom-4 left-1/2 transform -translate-x-1/2 bg-green-600/40 backdrop-blur-lg shadow-lg rounded-full flex justify-around items-center px-6 py-3 w-[90%] max-w-md border border-green-500/50 z-10">
