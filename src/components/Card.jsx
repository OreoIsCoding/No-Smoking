...
const Card = ({ image, title, description, link }) => {
  return (
    <div className="max-w-sm sm:max-w-md lg:max-w-lg bg-white border border-gray-300 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out p-4 sm:p-6 transform hover:scale-105">
      <a href={link} className="block overflow-hidden rounded-lg">
        <div className="flex flex-col lg:flex-row">
          <img
            className="w-full h-48 sm:h-56 lg:w-48 lg:h-auto object-cover rounded-t-lg lg:rounded-l-lg lg:rounded-none mb-4 lg:mb-0"
            src={image}
            alt={title}
          />
